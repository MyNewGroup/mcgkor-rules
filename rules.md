...
## 제한 사항 요약
제한 사항과 처벌 문단에 고시된 내용들을 일반 회원이 확인해야할 내용만 간추려서 요약한 내용입니다. 아래 규칙의 내용과 일치하지만 규칙으로서의 효력을 갖지 않습니다. 확실하지 않은 부분이 있다면 반드시 원문을 읽어보시기 바랍니다.\
마찬가지로, 아래 문단을 모두 읽 예정이라면, 이 부분은 넘어가도 됩니다.
* 운영진의 적절한 지시에 따르셔야 합니다.
...
<span style="color: green;">일반적인 팀원은 여기까지만 읽으시면 됩니다. 단 새로 가입하시는 경우, 꼭 모두 읽어 보세요.</span>
