...
## 제1장 MCG Korea
* **제1항** 우리 팀은 직접민주주의 실현을 지향하는 모두가 함께 운영하는 공간입니다.
* **제2항** 회원은 규칙을 준수하는 조건 하에 자유롭게 활동, 발언 및 행동할 권리가 있으며, 팀이나 활동 일체에 관한 질문과 요청 및 비판을 할 권리가 있습니다.
* **제3항** 팀의 모든 회원은 규칙을 준수하는 조건 하에 자신과 자신의 의견 및 행동에 대해 차별받지 않으며, 존중받을 권리가 있습니다.
* **제4항** 모든 팀원은 규칙을 준수하여야 하며, 준수하지 않아 발생하는 모든 일은 당사자가 책임을 집니다.
* **제5항** 모든 권리는 규칙을 준수하였을 때에만 효력이 발생합니다.
* **제6항** TruckersMP 계정을 포함한 각자의 소유물에 대한 권리와 책임은 회원 본인이 갖습니다. ETS2MCG는 이에 관여할 자격이 없으며, 이를 보호할 의무를 지니지 않습니다. 각자의 TruckersMP 계정은 본인이 규칙을 준수하여 밴을 받지 않도록 해야 합니다.

## 제2장 원칙
### 팀 가입 조건
* **제7항** 대한민국 국적을 가진 ETS2MCG의 회원은 MCG Korea에 소속되는 것을 원칙으로 합니다.
* **제8항 (팀 가입 조건)**
  * ① 본인 소유의 TruckersMP 계정을 보유한 사람만 ETS2MCG에 가입할 수 있습니다.
  * ② 14세(중학교 1학년) 이상만 ETS2MCG에 가입할 수 있습니다.

### 일반 활동 원칙
* **도덕의 준수** 회원은 원할한 운영과 적당한 분위기 유지를 위해 다음 사항을 준수해야 합니다.
